...
set "INPUT_A=%REPO_ROOT%\test_a.fits"
set "INPUT_B=%REPO_ROOT%\test_b.fits"
set "OUTPUT_DIFF=%REPO_ROOT%\test_diff_out.fits"
set "HOTPANTS_EXE=%BUILD_DIR%\hotpants.exe"
set "HOTPANTS_ARGS=-tu 1e9 -tuk 1e9 -iu 1e9 -iuk 1e9 -tl -1e9 -il -1e9 -ft 3 -nss 1 -rss 25"
